...
public:
    ...
    RegisterInst() = delete;
    RegisterInst(InstOp instop, std::string text, std::string rd, std::string rs, std::string rt);
...
public:
    ...
    LoadStoreInst(InstOp instop, std::string text, std::string rt, std::string imm, std::string rs);
